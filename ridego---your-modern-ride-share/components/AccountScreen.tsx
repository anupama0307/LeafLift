    ...
    >
      ...
      <div className="flex-1 text-left">
        <div className="flex items-center justify-between">
          ...
          {badge && (
            <span className="bg-[#f2b90d] text-[9px] font-black text-black px-2 py-0.5 rounded uppercase tracking-wider">{badge}</span>
          )}
        </div>
        {subtitle && (
      ...
      <div className="px-5 pb-24 pt-4 animate-in fade-in duration-500 bg-white dark:bg-black min-h-full">
        ...
        <div className="mt-8 flex items-center justify-between mb-8">
           <div className="flex items-center gap-4">
              <div className="size-20 rounded-[28px] bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center overflow-hidden border-4 border-[#f2b90d] shadow-xl">
              ...
              <div>
                 ...
                 <div className="flex items-center gap-2 mt-1">
                    <span className="bg-black dark:bg-white text-white dark:text-black text-[9px] font-black px-2 py-0.5 rounded uppercase tracking-widest">Verified Driver</span>
                    <div className="flex items-center text-[#f2b90d]">
        ...
        <div className="bg-black dark:bg-[#f2b90d] text-white dark:text-black p-6 rounded-[32px] mb-8 shadow-2xl relative overflow-hidden">
    ...
    <div className="px-5 pb-24 pt-4 animate-in fade-in duration-500 bg-white dark:bg-black min-h-full">
      <div className="flex justify-between items-center mt-6 mb-8">
        <div>
          ...
          <div className="mt-2 inline-flex items-center px-2.5 py-1 rounded-full bg-slate-100 dark:bg-zinc-900">
            <span className="material-icons-outlined text-sm mr-1 text-slate-900 dark:text-[#f2b90d]">star</span>
            <span className="text-sm font-bold text-black dark:text-white">5.0</span>
          </div>
        </div>
